...
export default function LessonMenu({ courseID, lesson, module }) {
  ...
  const [menuMobileClicked, setMobileClicked] = React.useState(false);
  return (
    <>
        ...
        <div className="main__lesson-menu-nav">
          ...
          }} className={menuMobileClicked ? "main__lesson-menu-user-btn main__lesson-menu-user-btn_hidden" : "main__lesson-menu-user-btn"}>
    ...
    <button onClick={() => {
      setMobileClicked((prevValue) => {
        return !prevValue;
      });
    }} className="main__lesson-menu-mobile">
      <FontAwesomeIcon icon={menuMobileClicked ? faXmark : faBars} />
    </button>
    </>
