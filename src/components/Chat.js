...
export default function Chat({ children, students, courseAuthor, user, messages, socket, moduleID, token }) {
  ...
  return (
    <div className='lesson__div-chat'>
      {children}
      {/* <ul style={{minHeight: 210, margin: 0, minWidth: 180, borderRight: '1px solid rgba(193,200,205, 0.7)', padding: 0}}></ul>
      <div></div> */}
