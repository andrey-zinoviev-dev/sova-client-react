...
import { motion } from "framer-motion";
export default function Dashboard({ setAddUserOpened }) {
    ...
    <>
      <header className='header'>
        ...
        <button onClick={openMenu} style={{display: window.innerWidth >= 767 ?  "none" : "block", backgroundColor: "transparent", color: "white", fontSize: 18, border: "none"}}>
          ...
          <svg style={{width: 35, height: 70}} version="1.0" xmlns="http://www.w3.org/2000/svg"
        ...
        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", gap: 25}}>
          <button onClick={() => {
            navigate('/addCourse');
          }} style={{color: "white", display: "flex", alignItems: "center", justifyContent: "center", width: 40, height: 40, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 20}}>
          ...
          }} style={{color: "white", display: "flex", alignItems: "center", justifyContent: "center", width: 40, height: 40, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 16}}>
          ...
          <button style={{width: 40, height: 40, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 20}}>{loggedUser._id && loggedUser.name[0]}</button>
        </div>
