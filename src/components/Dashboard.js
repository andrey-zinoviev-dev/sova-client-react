    ...
    <>
      <header className='header'>
        ...
        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", gap: 25}}>
          <button onClick={() => {
            navigate('/addCourse');
          }} style={{color: "white", display: "flex", alignItems: "center", justifyContent: "center", width: 50, height: 50, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 20}}>
          ...
          <motion.button style={{color: "white", display: "flex", alignItems: "center", justifyContent: "center", width: 50, height: 50, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 20}}>
          ...
          <button style={{width: 50, height: 50, padding: 0, backgroundColor: "transparent", border: "2px solid rgb(93, 176, 199)", borderRadius: 5, color: "rgb(93, 176, 199)", fontWeight: 500, fontSize: 20}}>{loggedUser._id && loggedUser.name[0]}</button>
        </div>
